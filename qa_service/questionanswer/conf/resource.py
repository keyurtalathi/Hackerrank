...
from questionanswer.exceptions.vaidation_exception import ValidationException
from questionanswer.exceptions.not_found_exception import NotFoundException
from questionanswer.exceptions.invalid_transition import InvalidTransition
from questionanswer.exceptions.unauthorised_exception import UnauthorisedException
from questionanswer.exceptions.generic_custom_exception import GenericCustomException
from questionanswer.exceptions.already_object_exist import AlreadyExist
...
class BaseResource(Resource):
    method_decorators = [handle_validation_exception, format_response]
