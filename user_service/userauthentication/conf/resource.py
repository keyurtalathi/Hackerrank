...
from flask_restful import Resource
from userauthentication.conf.error_object import ErrorObject
from userauthentication.exceptions.vaidation_exception import ValidationException
from userauthentication.exceptions.not_found_exception import NotFoundException
from userauthentication.exceptions.invalid_transition import InvalidTransition
from userauthentication.exceptions.unauthorised_exception import UnauthorisedException
from userauthentication.exceptions.generic_custom_exception import GenericCustomException
...
def sanitize_response(response):
    ...
    elif isinstance(response, tuple) and len(response) is 2:
